...
*/
  ...
  switch (overlay) {
    ...
    case "home":
      return <Home userData={userData} setUserData={setUserData} setCourses={setCourses} setOverlay={setOverlay} />
    case "assignments":
      return <Assignments userData={userData} courses={courses} setOverlay={setOverlay} />;
    default:
      return <h1>Something happened! Try reloading the page.</h1>
  }
}
